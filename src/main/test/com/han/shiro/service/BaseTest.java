...
import com.han.shiro.service.impl.PermissionServiceImpl;
import com.han.shiro.service.impl.RoleServiceImpl;
import com.han.shiro.service.impl.UserServiceImpl;
...
public abstract class BaseTest {
	...
	public void setUp() {
		...
		// 4、新增用户
		u1 = new User("han", password);
		u2 = new User("de", password);
		u3 = new User("xing", password);
		u4 = new User("handx", password);
